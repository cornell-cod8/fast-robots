...
![finding d and m](./lab7/T1_deriv_6.png)
...
![PWM values](./lab7/T1_input_speed_vs_time.png)
<!-- TODO: insert distance vs. time -->
![distance values](./lab7/T1_distance_vs_time.png)
...
![velocity code](./lab7/T1_velocity_code.png)
<!-- TODO: insert calculated car velocity vs. time -->
![velocity values](./lab7/T1_velocity_vs_time.png)
...
![discretization of A and B, among other things](./lab7/T2_discrete_etc.png)
...
![covariance stuff](./lab7/T2_covariance.png)
...
![covariance matrices](./lab7/T2_covariance_matrices.png)
